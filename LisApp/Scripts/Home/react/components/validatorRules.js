...
const requiredMax4Number = { validators: ['required', 'maxStringLength:4', 'isNumber'], errorMessages: [<Trans>RequiredField</Trans>, <Trans>Max4</Trans>, <Trans>IsNumber</Trans>], requiredMark: true };
...
const requiredPeselOrNN = { validators: ['required', 'maxStringLength:11', 'matchRegexp:^(([0-9]{4}[0-3][0-9]{6})|NN|([1-2][0-9]{3}-[0-1][0-9]-[0-3][0-9]))$'], errorMessages: [<Trans>RequiredFieldNN</Trans>, <Trans>Max11</Trans>, <Trans>IsPeselNN</Trans>], requiredMark: true };
...
const isPesel = { validators: ['maxStringLength:11', 'matchRegexp:^(([0-9]{4}[0-3][0-9]{6})|([1-2][0-9]{3}-[0-1][0-9]-[0-3][0-9]))$'], errorMessages: [<Trans>Max11</Trans>, <Trans>IsPesel</Trans>] };
const isPhone = { validators: ['maxStringLength:9', 'isNumber'], errorMessages: [<Trans>Max9</Trans>, <Trans>IsNumber</Trans>] };

export { requiredField, requiredMax15, requiredMax50, requiredPesel, requiredPhone, requiredFloat, requiredMax4Number, requiredOrNNMax50, requiredOrNNMax15, requiredPeselOrNN, requiredPhoneOnNN, isEmail, max50, isPesel, isPhone };